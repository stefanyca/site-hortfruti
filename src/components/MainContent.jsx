...
import { db } from '../firebase';                // corrigido: subir uma pasta
import QuemSomos from '../pages/QuemSomos';      // corrigido: subir uma pasta
import CategoriaCard from './CategoriaCard';     // mesma pasta, sem alteração
import '../App.css';                              // subir uma pasta para encontrar o CSS
...
export default function MainContent() {
  ...
  const abrirProdutosPorCategoria = (categoria) => {
    navigate('/loja', { state: { categoria, produtos } });
  };
  ...
  return (
    <div className="font-poppins relative">
      ...
      <footer className="bg-green-900 text-green-50 text-center py-4">
        <p>© 2023 Armazém Dona Lourdes. Todos os direitos reservados.</p>
      </footer>
    </div>
  );
}
