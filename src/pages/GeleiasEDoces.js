...
const GeleiasEDoces = () => {
  ...
  useEffect(() => {
    const fetchProdutos = async () => {
      const querySnapshot = await getDocs(collection(db, 'geleias-e-doces'));
  ...
  return (
    <section id="geleias-e-doces" className="px-8 py-20 bg-green-50 text-center">
      <h3 className="text-3xl font-bold text-green-900 mb-6">Geleias & Doces</h3>
